    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      <div class="container">
        <div class="navbar-header">
          ...
          <a href="<?php echo BASEURL; ?>home_marketing/index.php" class="navbar-brand">Home</a> 
        </div>
         ...
         <?php 
          ...
          <ul class="nav navbar-nav">
            ...
            if (isset($_REQUEST['pg'])) {
                ...
                $campoPlaceHolder = "evento ou edição";
            }
            ?>
            <ul class="nav navbar-nav">
			   ...
			   <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li><a href="<?php echo BASEURL; ?>usuarios/index.php"><i class="fa fa-user fa-fw"></i> Usuários</a>
                        </li>
        ...
        <div class="row">
            <div class="col-lg-12">
                <button type="button" class="btn btn-link"> 
                    <a href="#" ><i class="fa fa-filter"></i> Funil</a> 
                </button>
                <button type="button" class="btn btn-link"> 
                    <a href="#"><i class="fa fa-bookmark"></i> Eventos</a> 
                </button>
                <button type="button" class="btn btn-link"> 
                    <a href="#"><i class="fa fa-group"></i> Contatos</a> 
                </button>
                <button type="button" class="btn btn-link"> 
                    <a href="<?php echo BASEURL; ?>home_marketing/relatorio.php"><i class="fa fa-bar-chart-o"></i> relatórios</a> 
                </button>
                <button type="button" class="btn btn-link"> 
                    <a href="#"><i class="fa fa-gear"></i> Configurações</a> 
                </button>
            </div>
        </div>
    </div>
