    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      <div class="container">
        <div class="navbar-header">
          ...
          <a href="<?php echo BASEURL; ?>home_projeto/index.php" class="navbar-brand">Home</a> 
        </div>
          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a href="<?php echo BASEURL; ?>empresas/index.php">Contato</a></li>
                    <li><a href="<?php echo BASEURL; ?>eventos/index.php">Evento</a></li>  
					<li><a href="<?php echo BASEURL; ?>equipe/index.php">Equipe de vendas</a></li>
                    <li><a href="<?php echo BASEURL; ?>usuarios/index.php">Usuário</a></li>                </ul>
            </li>
            <li class="dropdown">
                <a id="a-link" href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                ...
                <ul class="dropdown-menu">
                    ...
                    <?php endif; ?>
					<li><a href="<?php echo BASEURL; ?>eventos/add.php">+ Novo atendimento</a></li>
                    <li><a href="<?php echo BASEURL; ?>eventos/add.php">+ Novo evento</a></li>
                    <li><a href="<?php echo BASEURL; ?>empresas/add.php">+ Novo cliente</a></li>
                    <li><a href="<?php echo BASEURL; ?>usuarios/add_novo_usuario.php">+ Novo usuário</a></li>
                    <?php if (0==1): ?>
                    <li><a href="#">+ Nova Categoria Cliente</a></li>
                    <li><a href="#">+ Novo Cargo Contato</a></li>                	
					<?php endif; ?>
                    </ul>                
            </li>
             <?php if (0==1): ?>
