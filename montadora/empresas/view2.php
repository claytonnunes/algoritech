...
?>
	...
	// Se n�o tiver evento cadastrado redireciona
	if ($eventos) :
	...
	<div class="row">
		<div class="form-group col-md-5">
			...
			<textarea class="form-control" id="exampleTextarea" rows="2" name="comentario" placeholder="Descreva o seu coment�rio..." required ></textarea>
		</div>
