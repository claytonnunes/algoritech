...
?> 
		...
		<div id="row">
			<div class="form-group col-md-12" align="left" >
				...
				<div class="form-group col-md-4" align="left" >
					<i class="glyphicon glyphicon-equalizer  " aria-hidden="true"></i> EMPRESA: 
				</div>
				<div class="form-group col-md-4" align="left" >
				...
				<div class="form-group col-md-4" align="right" >
					<a href="<?php echo BASEURL; ?>briefing/add.php?acao=novoProduto&id_atendimento=<?php echo $_REQUEST['id_atendimento']; ?>" class="btn btn-sm btn-success"><i class="fa fa-tags"></i> Novo produto</a>
				</div>
			</div>
		</div>
	</div>
	...
	<div id="divConteudo2">
		<div id="row">
			<div class="form-group col-md-12" align="left" >
				<h4>
				<i class="fa fa-tags fa-2x"></i> <?php echo "PRODUTO: ". $grupo_produto['nome']; ?></h4>
			</div>
		</div>
	</div>
	<div id="divConteudo2">
	...
	<?php endif; ?>
		...
		<tr>
			...
			<div class="row">
				<div class="col-md-12">
					<a href="<?php echo BASEURL; ?>briefing/add.php?acao=novoBriefing&id_briefing=<?php echo $briefing['id']; ?>" >
