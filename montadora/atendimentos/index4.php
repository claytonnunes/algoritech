...
<!--            </tr>-->
        ...
        ?>
                        ...
                        <td><?php  
							echo utf8_encode($atendimento['fone']); 
							?></td>
                          <td><?php  
							echo utf8_encode($atendimento['nome']);
							?></td>
                             <td><?php  
							echo utf8_encode($atendimento['email']);
							?></td>
                              <td><?php  
							echo utf8_encode($atendimento['fone2']);
							?></td>
                             <td><?php  
							echo utf8_encode($atendimento['celular']);
							?></td> <td><?php 
