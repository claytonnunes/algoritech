...
<!--            </tr>-->
      ...
      <?php  while ($loop_visitantes=mysql_fetch_array($sql_visitantes)) {
	...
	$id_evento = ($loop_visitantes["sess_fair_vendas"]);
	    ...
	    ?>
                            <tr>
                              <td><?php  
							echo utf8_encode($loop_visitantes['nome_fantasia']); 
							?></td>
                                 <td><?php  
							echo utf8_encode($loop_visitantes['fone']); 
							?></td>
                           <td><?php  
							echo utf8_encode($loop_visitantes['nome']); 
							?></td>
                             <td><?php  
							echo utf8_encode($loop_visitantes['email']); 
							?></td>
                             <td><?php  
							echo utf8_encode($loop_visitantes['fone2']); 
							?></td>
                              <td><?php  
							echo utf8_encode($loop_visitantes['celular']); 
							?></td>
