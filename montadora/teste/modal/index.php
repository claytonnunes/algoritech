<?php
	...
	$result_cursos = "SELECT * FROM grupo_produto";
							...
							<?php while($rows_cursos = mysqli_fetch_assoc($resultado_cursos)){ ?>
								<tr>
									...
									<td>
										...
										<button type="button" class="btn btn-xs btn-warning" data-toggle="modal" data-target="#exampleModal" data-whatever="<?php echo $rows_cursos['id']; ?>" data-whatevernome="<?php echo $rows_cursos['nome']; ?>"data-whateverdetalhes="<?php echo $rows_cursos['id_usuario']; ?>">Editar</button>
									...
									<div class="modal-dialog" role="document">
										<div class="modal-content">
											...
											<div class="modal-body">
												...
												<p><?php echo $rows_cursos['id_usuario']; ?></p>
											</div>
										</div>
									</div>
								</div>
