...
?>
    <form id="formEmpresa" name="formEmpresa" action="add.php?acao=salvarBriefing&id_atendimento=<?php echo $_REQUEST['id_atendimento']; ?>&id_grupo_produto=<?php echo $_REQUEST['id_grupo_produto']; ?>&id_empresa=<?php echo $_REQUEST['id_empresa']; ?>" method="post">
...
<h5>Histórico de briefing deste atendimento</h5>	
