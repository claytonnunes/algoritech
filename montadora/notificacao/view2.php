...
<table id="tabela2" class="table table-hover">
	...
	if ($briefings) : 
		foreach ($briefings as $briefing) :
			...
			pesquisaAtendimentoTres('id_pai', $_SESSION['id_pai'], 'id_atendimento', $briefing['id_atendimento'], 'deleted','0');
			if ($atendimentos) : 
			...
			<div id="row">
				<div class="form-group col-md-6" align="left">
					<?php 
						...
						echo "<strong>Produto: </strong>".$nome_grupo_produto."<br>";
				...
				<div class="form-group col-md-12" align="left">
				 ...
				 <div class="col-sm-12 text-left h4">
					<a class="btn btn-primary" href="<?php echo BASEURL; ?>projeto/upload_arquivo.php?id_negocio=<?php echo $_REQUEST['id_negocio']; ?>&id_briefing=<?php echo $_REQUEST['id_briefing']; ?>&numero_desenho=<?php echo $numeroDesenho; ?>&id_atendimento=<?php echo $id_atendimento; ?>"><i class="glyphicon glyphicon-cloud-upload"></i> Enviar projeto</a>
				</div>
			</div>
		</td>
