...
pesquisaBriefingAtivo($_REQUEST['id_grupo_produto']);
pesquisaBriefing();
	...
	<?php 	endif; ?>
    <form id="formEmpresa" name="formEmpresa" action="add.php?acao=salvarBriefing&numero_briefing=<?php echo $_REQUEST['numero_briefing']; ?>&id_atendimento=<?php echo $_REQUEST['id_atendimento']; ?>&numero_desenho=<?php echo $numero_desenho; ?>&id_grupo_produto=<?php echo $_REQUEST['id_grupo_produto']; ?>&id_empresa=<?php echo $_REQUEST['id_empresa']; ?>&id_briefing=<?php echo $id_briefing; ?>" method="post">
