...
findVendedores();
	...
	// SE PESQUISA POR EMPRESA
	if (isset($_REQUEST['pesquisa'])) {
		//echo "<br><br><br>Entrou na pesquisa de empresa!!!<br><br><br>";
	...
	// CÓDIGO PARA PESQUISAR FILTROS
	elseif (isset($_REQUEST['filtro'])) {
		if ($_REQUEST['filtro']=='filtroEdicao') {
			$_SESSION["id_edicao"] = $_REQUEST['id_edicao'];
			//echo "<br><br><br>Entrou no filtro da edição!!!<br><br><br>";
			if (isset($_SESSION['id_vendedor'])) {
				//echo "entrou no vendedor e edição";
			}
			else {
				echo "entrou na edição";
			pesquisaNegocio('id_pai', $_SESSION['id_pai'], 'id_usuario', $_SESSION['id_usuario'], 'id_edicao', $_REQUEST['id_edicao'], 'AND status = 0  AND deleted = 0 ORDER BY nome ASC');
			}
				
		}
		elseif (($_REQUEST['filtro']=='filtroVendedor') AND ($_SESSION['tipo_acesso']==0)) {
			$_SESSION["id_vendedor"] = $_REQUEST['id_vendedor'];
			//echo "<br><br><br>Entrou no filtro do vendedor!!!<br><br><br>";
			if ($_REQUEST['id_vendedor']=='todos') {
				pesquisaNegocio('id_pai', $_SESSION['id_pai'], 'status', '0', 'deleted', '0', 'ORDER BY nome ASC');
			}
			else {
				pesquisaNegocio('id_pai', $_SESSION['id_pai'], 'status', '0', 'id_usuario', $_REQUEST['id_vendedor'], ' AND deleted = 0 ORDER BY nome ASC');
			}
		}
	}
	// SE NÃO TIVER PESQUISA E NEM FILTRO SETADOS  
	else{
		//echo "<br><br><br>Código sem filtro!!!<br><br><br>";
			pesquisaNegocio('id_pai', $_SESSION['id_pai'], 'status', '0', 'id_usuario', $_SESSION['id_usuario'], ' AND deleted = 0 ORDER BY nome ASC');
			// pesquisaNegocio('id_pai', $_SESSION['id_pai'], 'status', '0', 'deleted', '0', 'ORDER BY nome ASC');
	}
		...
		<div class="row">
			...
			<div class="btn-group">
				...
				<ul class="dropdown-menu">
					...
					?>
					<li><a href="index.php?pg=funil&filtro=filtroVendedor&nome_vendedor=todos&id_vendedor=todos"><i class="fa fa-group"></i> TODOS</a></li>
					<hr>
			...
			<div class="btn-group">
				...
				<ul class="dropdown-menu">
					...
					<li><a href="<?php echo
					"index.php?pg=funil&filtro=filtroEdicao&nome_edicao=".$evento['nome_edicao']."&id_edicao=". $evento['id']; ?>"><?php echo $evento['nome_edicao']; ?></a></li>
					<?php
					endforeach;
					endif;
					?>
    ...
    <div class="col-lg-3">
		<div class="panel panel-default panel-danger">
			...
			<div class="row">
				...
				<p><strong><?php echo "<br>".$arrayNegocio['nome'];?></strong></p>
